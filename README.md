...
Ứng dụng sử dụng mô hình `model_hand.h5` đã được huấn luyện sẵn với dữ liệu hình ảnh chữ cái viết tay. Xem quá trình huấn luyện model tại file [https://github.com/Ducanh2005HUST/Handwritten-Character-Recognition-with-Neural-Network/blob/main/trainning%20model%20with%20framework%20Keras.ipynb]
...
├── pygameapp.py              # File chính chạy ứng dụng
